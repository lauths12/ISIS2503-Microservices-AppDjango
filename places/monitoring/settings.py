...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get("PLACES_DB_PASSWD", "places_user"),
        'HOST': os.environ.get("PLACES_DB_HOST", "10.128.0.83"),
...
PATH_VAR = "http://" + os.environ.get("PLACES_HOST", "10.128.0.84") + ":" + os.environ.get("PLACES_PORT", "8080") + "/PLACES"