...
def MeasurementCreate(request):
    if request.method == 'POST':
        ...
        if check_variable(data_json) == True and verify_place(data_json) == True:
...
def MeasurementsCreate(request):
    if request.method == 'POST':
        ...
        for measurement in data_json:
                    if check_variable(measurement) == True and verify_place(data_json) == True:
